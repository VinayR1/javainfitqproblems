/*
When two classes are related to each other by aggregation, reference of one class becomes a member of the other class and we can access the members of the aggregated class but what about the private members of the class. Try the below code to understand how this works.
*/
class Subject {
